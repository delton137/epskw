...
do i = 1, num_ind_mags
	if (i .lt. 11) then 
 		write(20,'(a,I1,a,1f6.2,a,1f6.2,a)') '@ s', i-1, ' legend "k = ', magk_tr(i) ,'\cE\C\S-1\N \f{Symbol}l\f{Times-Roman} =', &		
						(2.0*pi)/magk_tr(i),'\cE\C" '
	else
 		write(20,'(a,I2,a,1f6.2,a,1f6.2,a)') '@ s', i-1, ' legend "k =', magk_tr(i) ,'\cE\C\S-1\N \f{Symbol}l\f{Times-Roman} =',  &
						 (2.0*pi)/(i),'\cE\C" '
	endif
enddo
